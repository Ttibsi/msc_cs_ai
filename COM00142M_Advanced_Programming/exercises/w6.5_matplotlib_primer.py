...
comp1 = numpy.random.standard_normal(200)
comp2 = 10 + 2 * numpy.random.standard_normal(200)
values = pandas.Series(numpy.concatenate([comp1, comp2]))
seaborn.histplot(values, bins=100, color="black")
plt.show()
